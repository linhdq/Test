 ...
 * the License.
 */
package com.example.linhdq.test.documents.creation.visualisation;
...
import com.example.linhdq.test.android.OCR;
import com.example.linhdq.test.documents.viewing.DocumentContentProvider;
import com.example.linhdq.test.documents.viewing.grid.DocumentGridActivity;
import com.example.linhdq.test.documents.viewing.single.DocumentActivity;
import com.example.linhdq.test.util.Screen;
...
public class OCRActivity extends MonitoredActivity implements LayoutQuestionDialog.LayoutChoseListener {
    ...
    private Uri saveDocumentToDB(File imageFile, String hocr, String plainText)
        ...
        try {
            ...
            if (hocr != null) {
                v.put(DocumentContentProvider.Columns.HOCR_TEXT, hocr);
            }
            if (plainText != null) {
                v.put(DocumentContentProvider.Columns.OCR_TEXT, plainText);
            }
            v.put(DocumentContentProvider.Columns.OCR_LANG, mOcrLanguage);
