 ...
 * the License.
 */
package com.example.linhdq.test.documents.creation.crop;
...
import static com.example.linhdq.test.documents.creation.crop.HighLightView.GROW_BOTTOM_EDGE;
import static com.example.linhdq.test.documents.creation.crop.HighLightView.GROW_LEFT_EDGE;
import static com.example.linhdq.test.documents.creation.crop.HighLightView.GROW_NONE;
import static com.example.linhdq.test.documents.creation.crop.HighLightView.GROW_RIGHT_EDGE;
import static com.example.linhdq.test.documents.creation.crop.HighLightView.GROW_TOP_EDGE;
import static com.example.linhdq.test.documents.creation.crop.HighLightView.MOVE;
