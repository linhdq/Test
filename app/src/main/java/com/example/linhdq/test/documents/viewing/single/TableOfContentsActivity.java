...
public class TableOfContentsActivity extends MonitoredActivity implements LoaderManager.LoaderCallbacks<Cursor>, OnItemClickListener {
    private final static String[] PROJECTION = {DocumentContentProvider.Columns.ID, DocumentContentProvider.Columns.TITLE, DocumentContentProvider.Columns.OCR_TEXT, DocumentContentProvider.Columns.CREATED};
    ...
    public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
        ...
        final String selection = DocumentContentProvider.Columns.PARENT_ID + "=? OR " + DocumentContentProvider.Columns.ID + "=?";
    ...
    public void onLoadFinished(Loader<Cursor> arg0, Cursor cursor) {
        ...
        final SimpleDocumentAdapter adapter = new SimpleDocumentAdapter(this, R.layout.item_list_table_of_contents_element, cursor, new SimpleDocumentAdapter.ViewBinder() {

            @Override
            public void bind(View v, SimpleDocumentAdapter.DocumentViewHolder holder, String title, CharSequence formattedDate, String text, int position, final int id) {
