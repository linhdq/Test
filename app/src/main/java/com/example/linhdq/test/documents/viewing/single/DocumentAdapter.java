...
public class DocumentAdapter extends FragmentStatePagerAdapter {
    ...
    public DocumentAdapter(FragmentManager fm, final Cursor cursor) {
        super(fm);
        mCursor = cursor;
        mIndexOCRText = mCursor.getColumnIndex(DocumentContentProvider.Columns.OCR_TEXT);
        mIndexImagePath = mCursor.getColumnIndex(DocumentContentProvider.Columns.PHOTO_PATH);
        mIndexTitle = mCursor.getColumnIndex(DocumentContentProvider.Columns.TITLE);
        mIndexId = mCursor.getColumnIndex(DocumentContentProvider.Columns.ID);
        mIndexLanguage = mCursor.getColumnIndex(DocumentContentProvider.Columns.OCR_LANG);
    }
