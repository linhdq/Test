...
public class DocumentGridAdapter extends CursorAdapter implements CheckableGridElement.OnCheckedChangeListener {
	...
	private final static String[] PROJECTION = { DocumentContentProvider.Columns.ID, DocumentContentProvider.Columns.TITLE, DocumentContentProvider.Columns.OCR_TEXT, DocumentContentProvider.Columns.CREATED, DocumentContentProvider.Columns.PHOTO_PATH, DocumentContentProvider.Columns.CHILD_COUNT };
	...
	public DocumentGridAdapter(DocumentGridActivity activity, int elementLayout, OnCheckedChangeListener listener) {
		...
		mIndexCreated = c.getColumnIndex(DocumentContentProvider.Columns.CREATED);
		mIndexID = c.getColumnIndex(DocumentContentProvider.Columns.ID);
		mIndexTitle = c.getColumnIndex(DocumentContentProvider.Columns.TITLE);
		mChildCountID = c.getColumnIndex(DocumentContentProvider.Columns.CHILD_COUNT);
	...
	public long getItemId(int position) {
		if (getCursor().moveToPosition(position)) {
			int index = getCursor().getColumnIndex(DocumentContentProvider.Columns.ID);
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		...
		int index = cursor.getColumnIndex(DocumentContentProvider.Columns.ID);
